...
export const longVideos: VideoItem[] = [
  { url: "https://youtu.be/e1HMTzkBDR0", title: "ГРОМ.KO — Akatsuki Drums (промо)", subtitle: "Концертный промо-ролик" },
  { url: "https://youtu.be/n8lYENa718c", title: "Дудл-видео (doodle video)", subtitle: "Озвучивала нейросеть" },
  { url: "https://youtu.be/06jxSi6jtik", title: "Бьюти-ролик" },
  { url: "https://youtu.be/zGbYBkSNT54", title: "3D анимация логотипа — CISM" },
  { url: "https://youtu.be/ZX494YH2Jpw", title: "Приключения Бони и Джека", subtitle: "Мультфильм сделанный с помощью ИИ инструментов" },
  { url: "https://youtu.be/5WPjoD-h-sI", title: "Ролик для курса Imagine B", subtitle: "Логотип для бизнеса" },
  // …остальные (можно постепенно дополнять subtitle где нужно)


// — Остальные длинные (горизонтальные) видео

  { url: "https://youtu.be/RctOuZDoRoE", title: "ГРОМ.КО — комбинация нейросеть+IRL" },
  { url: "https://youtu.be/rqVoWXKTRvA", title: "Заставка для группы ТО2" },
  ...
  { url: "https://youtu.be/t8KCWUoMhck", title: "Подборка видео с нейросетями", subtitle: "2024" },
  ...
  { url: "https://youtu.be/YvehMG95G4Q", title: "Трейлер игры", subtitle: "Оживление картинок нейросетью + монтаж" },
  ...
  { url: "https://youtu.be/6TuhZz3pv3k", title: "Интервью с Дмитрием Красиловым" },
  { url: "https://youtu.be/Nss4Qq0OhqE", title: "Реклама яхтенных туров" },
  { url: "https://youtu.be/uknwS-KmvA8", title: "Субтитры для интервью" },
];
...
export const shortsVideos: VideoItem[] = [
  ...
  { url: "https://youtube.com/shorts/kT_tCGSeGuM?si=R9pq-UianqZlKqTo", title: "Shorts для канала режиссёра №2", isShort: true },
  { url: "https://youtube.com/shorts/MWFQ4RWZMXQ?feature=share", title: "Shorts — трейлер книги (нейросеть)", isShort: true },
